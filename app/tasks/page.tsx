...
export default function TasksPage() {
  ...
  useEffect(() => { const params = new URLSearchParams(window.location.search); const queryType = params.get("type"); if (params.get("new") === "1") setCreating(true); if (queryType === "inhouse" || queryType === "outsource") setType(queryType); }, []);
